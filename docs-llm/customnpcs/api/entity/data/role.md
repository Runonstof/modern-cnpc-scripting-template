...
- `void setSong​(java.lang.String song)`
...
- `void setFollowing​(java.lang.String name)`
- `boolean isFollowing()`
...
- `void setDialog​(java.lang.String text)`
- `java.lang.String getOption​(int option)`
- `void setOption​(int option, java.lang.String text)`
  - param: option - The dialog option (1-6)
- `java.lang.String getOptionDialog​(int option)`
- `void setOptionDialog​(int option, java.lang.String text)`
  - param: option - The dialog option (1-6)
