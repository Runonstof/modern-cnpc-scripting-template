...
*class* `noppes.npcs.api.constants.EntityType`
...
### Methods
- `public static net.minecraft.util.EnumParticleTypes getMCType​(int type)`
...
### Methods
- `public static net.minecraft.potion.Potion getMCType​(int effect)`
...
*class* `noppes.npcs.api.constants.TacticalType`
