...
All Superinterfaces: IEntity<T>, IEntityLiving<T>, IMob<T>
...
- `int getType()`
  - returns: Returns the EntitiesType of this entity
- `boolean typeOf(int type)`
  - param: type - EntitiesType to check
  - returns: Returns whether the entity is type of the given EntitiesType
- `T getMCEntity()`
  Expert users only
...
*interface* `noppes.npcs.api.entity.IMob`

All Superinterfaces: IEntity<T>, IEntityLiving<T>
...
All Superinterfaces: IAnimal<T>, IEntity<T>, IEntityLiving<T>, IMob<T>
...
- `int inventoryItemCount(String id)` (deprecated)
  Use getInventory().count instead
...
- `boolean hasAdvancement(String achievement)`
  ...
  - returns: Returns whether or not the player has this achievement
- `int getExpLevel()`
